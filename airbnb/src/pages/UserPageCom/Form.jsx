  ...
  return (
    <div className='flex m-8 items-center justify-center'>
        <form onSubmit={addNewPlace}>
            <div className='p-9 w-[100%] border flex justify-center items-center flex-col rounded-md'>
                <span>Upload Your Product</span>
                <div className='flex p-2 gap-x-4'>
                    <div onDrop={handleDrop}
                        onDragOver={(event) => event.preventDefault()}
                        className='p-10 flex-col bg-[#A4A4CB] bg-opacity-10 flex border rounded-md border-dashed border-[#A4A4CB] justify-center items-center'>
